        ...
        if (codeBlock.lang === 'output') {
            ...
            if (exampleBlock && exampleBlock.lang === 'javascript') {
                if (exampleBlock.errorMessage) {
                    output = exampleBlock.errorMessage;
                }
            }
            return '```' + lang + '\n' + output + '\n```';
        } else {
...
module.exports = function plugin(options) {
                ...
                try {
                    ...
                    if (codeBlock.flags.async) {
                        ...
                        promise.then(function () {
                            ...
                            codeBlock.htmlErrorMessage = getErrorMessage(global.expect, 'html', e);
                            codeBlock.errorMessage = getErrorMessage(global.expect, 'text', e);
                            cb();
                        });
                    } else {
    ...
    function createUpdatedMarkdown(expect, content, codeBlocks, options) {
        ...
        renderer.code = function(code, blockInfoString, escaped) {
            ...
            if (lang === 'output') {
                if (exampleBlock && exampleBlock.lang === 'javascript') {
                    if (exampleBlock.htmlErrorMessage) {
                        return exampleBlock.htmlErrorMessage
